...
var loadedDict = {
    ...
    "zwblmaxmin.description": "Height above sea level of the values shown in Collective Up/Down Motion (Convergence/Divergence) within the boundary layer.",
    ...
    "sfcwind0.description": "Wind speed and direction 2m above ground.",
    "sfcwind.longname": "Surface Wind (10m)",
    "sfcwind.description": "Wind speed and direction 10m above ground.",
    "sfcwind2.longname": "Surface Wind (30m)",
    "sfcwind2.description": "Wind speed and direction 30m above ground.",
    "blwind.longname": "Boundary Layer Average Wind",
    "blwind.description": "Speed and direction of the vector-averaged wind in the boundary layer. This prediction can be misleading if there is a large change in wind direction within the boundary layer.",
    "bltopwind.longname": "Boundary Layer Top Wind",
    "bltopwind.description": "Wind speed and direction at the top of the boundary layer.",
    "blwindshear.longname": "Boundary Layer Wind Shear",
    "blwindshear.description": "Vertical change in wind within the boundary layer, specifically the magnitude of the vector-difference of top and bottom boundary layer wind. Note that this represents vertical wind shear and does not indicate so-called shear lines (which are horizontal changes of wind speed/direction).",
    ...
    "press.longname": "Pressure level",
    "press.description": "Wind velocity and direction as well as collective vertical movement in selected pressure level.",
